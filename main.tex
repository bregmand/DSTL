...
%Here we have included exemplary codes for the implemented universal adversarial attack and universal adversarial attack and defence as described in Section \ref{sec:uniadvtrain}.

\includepdf[scale=0.8,page=1,pagecommand=\section{Appendix}]{universal_adversarial_attack.pdf}
\includepdf[,page={2,3,4,5,6}]{universal_adversarial_attack.pdf}
\includepdf[page={1,2,3,4,5}]{to_the_rescue.pdf}
